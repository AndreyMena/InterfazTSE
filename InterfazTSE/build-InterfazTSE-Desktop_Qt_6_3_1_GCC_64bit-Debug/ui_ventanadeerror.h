...
"image: url(:/resource/img/Error.png);"));
    ...
    {
        ventanaDeError->setWindowTitle(QCoreApplication::translate("ventanaDeError", "Form", nullptr));
        label->setText(QCoreApplication::translate("ventanaDeError", "Se ha producido un error en el programa. Lamentamos el inconveniente!", nullptr));
        pushButton->setText(QCoreApplication::translate("ventanaDeError", "Ok", nullptr));
    } // retranslateUi
